...
var scheduleTableSpecs = []tableSpec{
	...
	{Name: "m_mom_banner", EntityName: "EntityMMomBanner", Keys: []columnSpec{column("MomBannerId", 0), column("SortOrderDesc", 1), column("DestinationDomainType", 2), column("BannerAssetName", 4)}, Times: []columnSpec{column("StartDatetime", 6), column("EndDatetime", 7)}},
