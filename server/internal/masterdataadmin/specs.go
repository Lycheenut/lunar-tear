...
var activityTableSpecs = []tableSpec{
	...
	activityTable("m_big_hunt_weekly_attribute_score_reward_group_schedule", "EntityMBigHuntWeeklyAttributeScoreRewardGroupSchedule", 3, true, field("BigHuntWeeklyAttributeScoreRewardGroupScheduleId", 0, "int"), field("AttributeType", 1, "AttributeType"), field("GroupIndex", 2, "int"), field("BigHuntScoreRewardGroupId", 3, "int"), field("StartDatetime", 4, "long")),
	...
	activityTable("m_dokan", "EntityMDokan", 1, true, field("DokanId", 0, "int"), field("SortOrder", 1, "int"), field("DokanType", 2, "DokanType"), field("StartDatetime", 3, "long"), field("EndDatetime", 4, "long"), field("DokanContentGroupId", 5, "int"), field("TargetUserStatusType", 6, "TargetUserStatusType"), field("UnlockMainFunctionType", 7, "MainFunctionType")),
	...
	activityTable("m_mission_term", "EntityMMissionTerm", 1, true, field("MissionTermId", 0, "int"), field("StartDatetime", 1, "long"), field("EndDatetime", 2, "long")),
	...
	activityTable("m_navi_cut_in", "EntityMNaviCutIn", 1, true, field("NaviCutInId", 0, "int"), field("RelatedCutInFunctionType", 1, "CutInFunctionType"), field("SortOrder", 2, "int"), field("StartDatetime", 3, "long"), field("EndDatetime", 4, "long"), field("NaviCutInContentGroupId", 5, "int"), field("RelatedCutInFunctionValue", 6, "int")),
	...
	activityTable("m_tip", "EntityMTip", 1, true, field("TipId", 0, "int"), field("TitleTipTextId", 1, "int"), field("ContentTipTextId", 2, "int"), field("TipDisplayConditionGroupId", 3, "int"), field("BackgroundAssetName", 4, "string"), field("StartDatetime", 5, "long"), field("EndDatetime", 6, "long")),
	...
	activityTable("m_big_hunt_boss_quest", "EntityMBigHuntBossQuest", 1, false, field("BigHuntBossQuestId", 0, "int"), field("BigHuntBossId", 1, "int"), field("BigHuntQuestGroupId", 2, "int"), field("BigHuntBossQuestScoreCoefficientId", 3, "int"), field("BigHuntScoreRewardGroupScheduleId", 4, "int"), field("BigHuntLinkId", 5, "int"), field("DailyChallengeCount", 6, "int")),
	activityTable("m_big_hunt_score_reward_group", "EntityMBigHuntScoreRewardGroup", 2, false, field("BigHuntScoreRewardGroupId", 0, "int"), field("NecessaryScore", 1, "long"), field("BigHuntRewardGroupId", 2, "int")),
	...
	activityTable("m_gacha_medal", "EntityMGachaMedal", 1, false, field("GachaMedalId", 0, "int"), field("CeilingCount", 1, "int"), field("ConsumableItemId", 2, "int"), field("ShopTransitionGachaId", 3, "int"), field("AutoConvertDatetime", 4, "long"), field("ConversionRate", 5, "int")),
	...
	deliveryTable("m_big_hunt_reward_group", "EntityMBigHuntRewardGroup", 2, field("BigHuntRewardGroupId", 0, "int"), field("SortOrder", 1, "int"), field("PossessionType", 2, "PossessionType"), field("PossessionId", 3, "int"), field("Count", 4, "int")),
	...
	deliveryTable("m_quest_pickup_reward_group", "EntityMQuestPickupRewardGroup", 2, field("QuestPickupRewardGroupId", 0, "int"), field("SortOrder", 1, "int"), field("BattleDropRewardId", 2, "int")),
}
