...
func buildCatalogs(
	...
	requireCompleteGacha bool,
	requireCurrentQuestDrops bool,
) (*Catalogs, error) {
	...
	dropRewardsByQuestID, err := questdrop.BuildOverrides(questDropConfig, questCatalog, questdrop.BuildOptions{
		RequireCurrentMasterData: requireCurrentQuestDrops,
	...
	return &Catalogs{
		...
		GachaConfigHash:       gachaConfigHash,
		GachaConfigExists:     gachaConfigExists,
		QuestDropConfig:       questDropConfig,
		QuestDropConfigHash:   questDropConfigHash,
		QuestDropConfigExists: questDropConfigExists,
