...
func TestHandleQuestSkipBulkAggregatesDuplicateQuestLimits(t *testing.T) {
	...
	if _, err := h.HandleQuestSkipBulk(user, []int32{10, 10}, []int32{1, 1}, []int32{0, 0}, []int32{2, 2}, 0, 100); err == nil {
...
func TestDailyClearLimitResetsAfterServerDateChanges(t *testing.T) {
	...
	if _, err := h.HandleQuestSkip(user, 10, int32(model.QuestTypeMain), 0, 0, 1, now); err != nil {
