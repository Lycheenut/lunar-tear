...
func TestReadConfigDistinguishesMissingAndSavedEmpty(t *testing.T) {
	...
	empty := &Config{Version: ConfigVersion, Units: []ActivityUnit{}, Groups: []ActivityGroup{}}
	...
	for _, invalid := range []string{`null`, `{}`, `{"version":99}`, `{"version":1,"banners":{}}`, `{"version":1} {}`, `{"version":1,"eventSchedules":{}}`} {
